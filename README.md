...
Static, browser-based calculators for mixing, heating, and PGI-based efficiency checks. No login or backend required.
...
- Workbook-driven PGI efficiency checks by TP block.
...
- `pgi-metrics.html`: PGI workbook metrics calculator.
